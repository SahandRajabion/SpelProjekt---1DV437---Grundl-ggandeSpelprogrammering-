...
namespace GameProj.View
{
    class GameView
    {
        ...
        // Some code created by Daniel Toll: (https://code.google.com/p/1dv437arkanoid/source/browse/trunk/Collisions/Collisions2/View/View.cs).
        ...
        private SpriteFont levelSprite;
        ...
        public GameView(GraphicsDevice GraphicsDevice, ContentManager Content, Model.Model m_model)
        {
            ...
            levelSprite = Content.Load<SpriteFont>("level");
       ...
       internal void AnimateStill(float timeElapsedMilliSeconds, Movement movement)
        ...
        public void DrawLevel(int Currentlevel)
        {
            ...
            spriteBatch.Begin();
            spriteBatch.DrawString(levelSprite, "Current Level: " + Currentlevel, position, Color.White);
            spriteBatch.End();
        }
